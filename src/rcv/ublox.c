...
static int decode_trkmeas(raw_t *raw)
{
    ...
    /* if using ublox m8n with firmware 2.01, set fw to 2. added by morgan 
        refer to  https://rtklibexplorer.wordpress.com/2016/11/30/pseudorange-corrections-for-the-u-blox-trk-meas-command/
        https://wiki.openstreetmap.org/wiki/UbloxRAW 
    */
        fw=2; 
